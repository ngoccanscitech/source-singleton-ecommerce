...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">List Sponser</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
	      	...
	      	<div class="col-12">
	        	<div class="card">
		          	...
		          	<div class="card-body">
                        <ul class="nav">
                            <li class="nav-item">
                                <a class="btn btn-danger" onclick="delete_id('sponser')" href="javascript:void(0)"><i class="fas fa-trash"></i> Delete</a>
                            </li>
                            <li class="nav-item">
                                <a class="btn btn-primary" href="{{route('admin.createSponser')}}" style="margin-left: 6px;"><i class="fas fa-plus"></i> Add New</a>
                            </li>
                        </ul>
                        <br/>
                            ...
                            $(function() {
                                ...
                                $('#table_index').DataTable({
                                    ...
                                    {//Title
                                        ...
                                        className: 'text-center',
                                        render: function (data, type, full, meta) {
                                            return '<a href="{{route("admin.dashboard")}}/sponser/' + full.id + '"><b>'+data+'</b><br/><b style="color:#c76805;">'+full.order+'</b></a>';
                                        }
                                    },
                                    {//Thumbnail
                                        visible: true,
