  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020 <a href="{{route('index')}}">{{\App\Libraries\Helpers::get_option_minhnn('site-name')}}</a>.</strong> All rights reserved. Thiết kế <a href="https://thietkewebnhanh247.com/" target="_blank">Website</a> bởi <a href="https://www.expro.vn/" target="_blank">Expro Việt Nam</a>
  </footer>
