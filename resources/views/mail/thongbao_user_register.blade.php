               ...
               <tbody>
                  <tr>
                     <td valign="top">
                        ...
                        <p style="font-size:12px;line-height:16px;margin:0 0 8px 0">Tài khoản của bạn đã được kiểm duyệt.</p>
                        <p style="font-size:12px;line-height:16px;margin:0 0 8px 0">Nếu tài khoản của bạn vẫn chưa được kiểm duyệt. Vui lòng liên hệ với chúng tôi qua hotline <b>{{ setting_option('hotline') }}</b></p>
