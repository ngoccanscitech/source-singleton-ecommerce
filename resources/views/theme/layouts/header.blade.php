    ...
    <div class="navbar navbar-expand-lg navbar-light">
        <div class="container">
            <a class="navbar-brand d-none d-sm-inline-block flex-shrink-0" href="/">
                <img src="{{ setting_option('logo') }}" width="142" alt="{{ setting_option('name-company') }}">
            </a>
            <a class="navbar-brand d-sm-none flex-shrink-0 me-2" href="/">
                <img src="{{ setting_option('logo') }}" width="74" alt="{{ setting_option('name-company') }}">
            </a>
            <a href="/" class="domain-name">thuocnhanh<span>5p</span>.com</a>

            <form class="search-top d-none d-lg-flex mx-4 w-100" action="{{ route('search') }}">
            ...
            <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center">
                ...
                @if(Auth::check())
                  <a class="navbar-tool ms-1 ms-lg-0 me-n1 me-lg-2" href="{{ route('customer.profile') }}" >
                     <div class="navbar-tool-icon-box"><i class="navbar-tool-icon ci-user"></i></div>
                     <div class="navbar-tool-text ms-n3">{{ request()->user()->fullname }}</div>
                  </a>
                @else
                ...
                <div class="navbar-tool dropdown ms-3 site-cart">
                    <a class="navbar-tool-icon-box dropdown-toggle" href="{{ route('cart') }}">
                        <span class="navbar-tool-label" id="CartCount">{{ Cart::count() }}</span>
                        <!-- <i class="navbar-tool-icon ci-cart"></i> -->
                        <img src="{{ asset($templateFile .'/images/icon-cart.png') }}">
                    </a>
                            ...
                            <div class="mega-dropdown-column">
                              <div class="widget widget-links">
                                <ul class="widget-list">
                                  ...
                                  <li class="widget-list-item mb-2"><a class="widget-list-link" href="{{ url($menu['link']) }}">{{ $menu['label'] }}</a></li>
                                  @endforeach
                                </ul>
                              </div>
                            </div>
