    ...
    <div class="your-payment">
        ...
        <div class="d-flex align-items-center mb-3">
            <div class="custom-control custom-radio mr-2">
                <input type="radio" id="payment_paypal" name="payment_method" value="cash" class="custom-control-input" {{ $payment_method == '' ? 'checked' : '' }} {{ $payment_method == 'cash' ? 'checked' : '' }}>
        ...
        <div class="d-flex align-items-center">
            <div class="custom-control custom-radio mr-2 w-100">
                <input type="radio" id="payment_credit_card" name="payment_method" value="bank_transfer" class="custom-control-input"  {{ $payment_method == 'bank_transfer' ? 'checked' : '' }}>
                <label class="custom-control-label" for="payment_credit_card">Thanh toán Chuyển khoản</label>
                <div class="payment-content p-3 border rounded mt-2"  {!! $payment_method == 'bank_transfer' ? '' : 'style="display: none;"' !!} >
