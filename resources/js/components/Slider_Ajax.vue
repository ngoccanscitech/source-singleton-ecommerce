<template>
    <div id="load_slider">
        <div v-if="loading">
            <p class="tai">Đang tải dữ liệu..</p></p><div id="loader"></div>
        </div>
        <div class="slide-page" ref="slick" :options="slickOptions"  v-if="sliders.length">
            <div class="item-slide" v-for="slider in sliders" :key="sliders.id">
