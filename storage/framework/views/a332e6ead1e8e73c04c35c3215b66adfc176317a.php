  ...
  <div class="offcanvas-body">
    ...
    <div class="widget widget-categories mb-4 ">
      <h3 class="widget-title d-flex align-items-center">
        <img class="me-4 ms-3" src="<?php echo e(asset($templateFile .'/images/filter-icon.png')); ?>" height="12"> Danh mục mỹ phẩm
      </h3>
      <div class="accordion mt-n1" id="shop-categories">
        ...
        <div class="accordion-item">
          <h3 class="accordion-header">
            <a class="accordion-button collapsed" href="<?php echo e(route('shop.detail', $category->slug)); ?>" ><?php echo e($category->name); ?></a>
          </h3>
        </div>
    ...
    <div class="widget widget-filter mb-4" style="display: none;">
      <h3 class="widget-title d-flex align-items-center"><img class="me-4 ms-3" src="<?php echo e(asset($templateFile .'/images/filter-icon.png')); ?>" height="12"> Bộ lọc mỹ phẩm</h3>
...
</div><?php /**PATH C:\wamp64\www\expro\khanhkhoi\resources\views/theme/product/sidebar.blade.php ENDPATH**/ ?>