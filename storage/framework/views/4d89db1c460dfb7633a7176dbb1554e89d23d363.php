...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <?php if(Auth::guard('admin')->user()->admin_level == 99999): ?>
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.email_template')); ?>" class="nav-link">
    ...
    <!-- /.sidebar -->
</aside><?php /**PATH C:\wamp64\www\expro\khanhkhoi\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>