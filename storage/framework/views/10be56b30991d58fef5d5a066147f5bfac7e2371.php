              	...
              	<form action="<?php echo e(route('admin.postThemeOption')); ?>" method="POST" id="frm-theme-option" enctype="multipart/form-data">
		              ...
		              <?php 
						...
						<?php if($settings->count()): ?>
							<div class="group_item_theme_sort">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/domains/exproweb.com/public_html/nhathuockhanhkhoi/resources/views/admin/setting/theme-option.blade.php ENDPATH**/ ?>